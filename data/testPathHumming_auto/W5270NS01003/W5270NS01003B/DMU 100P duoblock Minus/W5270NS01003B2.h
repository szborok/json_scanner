...
12 ;
13 ; --- TOOLLIST BEGIN ---------------
14 ; T1210078320 | TGT-TDR-TF18_H63W25L90 / DM=18 CR=0 TL=201  
15 ; ---- TOOLLIST END ----------------
16 ;
17 ; --- BLOCK FORM -------------------
...
31 ; ----------------------------------
32 * - TOOL: T1210078320 | TGT-TDR-TF18_H63W25L90 / DM=18 CR=0 TL=201
33 TOOL CALL "TD18000001110350" Z S1768 DL+0 DR+0
...
60 CYCL DEF 200 DRILLING~
   ...
   Q202=52 ;PLUNGING DEPTH~
   Q210=0 ;DWELL TIME AT TOP~
   Q203=2 ;SURFACE COORDINATE~
   Q204=28 ;2ND SET-UP CLEARANCE~
   Q211=0 ;DWELL TIME AT BOTTOM
61 L X144 Y49 R0 F MAX M99
62 L X144 Y-49 R0 F MAX M99
63 L X-214 Y-49 R0 F MAX M99
64 L X-214 Y49 R0 F MAX M99
65 M9
66 M5

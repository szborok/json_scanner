1 BEGIN PGM W5270NS01060A19 MM
2 ; ----------------------------------
3 ; PROJECT	  :
4 ; DRAWING NUMBER:
5 ; INDEX   	  :
...
13 ;
14 ; --- TOOLLIST BEGIN ---------------
15 ; T437249783 | TGT-TOP5-TF25_H63W25L90 / DM=25 CR=0 TL=237
16 ; ---- TOOLLIST END ----------------
17 ;
18 ; --- BLOCK FORM -------------------
...
34 L A0 R0 FMAX
35 ; ----------------------------------
36 * - TOOL: T437249783 | TGT-TOP5-TF25_H63W25L90 / DM=25 CR=0 TL=237
37 TOOL CALL "TF25000001470350" Z S915 DL+0 DR+0
38 ; ----------------------------------
39 *   - JOB: 22: D25
40 ; ----------------------------------
41 CALL LBL 1 ; RESET WORKING PLANE
42 FN 0:Q3=48 ; Z FEED RATE
43 ; --- SAFEPOSITION -----------------
44 L Z0 R0 FMAX M91
45 L X0 R0 FMAX M91
...
60 CYCL DEF 200 DRILLING~
  ...
  Q202=30.007 ;PLUNGING DEPTH~
  Q210=0 ;DWELL TIME AT TOP~
  Q203=0 ;SURFACE COORDINATE~
  Q204=57 ;2ND SET-UP CLEARANCE~
  Q211=0 ;DWELL TIME AT BOTTOM
61 L X-94.5 Y0 R0 F MAX M99
62 L X-14.5 Y0 R0 F MAX M99
63 L X65.5 Y0 R0 F MAX M99
64 L X145.5 Y0 R0 F MAX M99
65 M9
66 M5
...
99 LBL 0
100 ; ----------------------------------
101 END PGM W5270NS01060A19 MM

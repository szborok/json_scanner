...
13 ;
14 ; --- TOOLLIST BEGIN ---------------
15 ; T714881895 | GUH-5512-BHF4_H63Z6L80 / DM=4 CR=0 TL=121
16 ; ---- TOOLLIST END ----------------
17 ;
18 ; --- BLOCK FORM -------------------
...
34 L A0 R0 FMAX
35 ; ----------------------------------
36 * - TOOL: T714881895 | GUH-5512-BHF4_H63Z6L80 / DM=4 CR=0 TL=121
37 TOOL CALL "BH04000000410172" Z S6366 DL+0 DR+0
38 ; ----------------------------------
39 *   - JOB: 1: D4
40 ; ----------------------------------
41 CALL LBL 1 ; RESET WORKING PLANE
42 FN 0:Q3=509 ; Z FEED RATE
43 ; --- SAFEPOSITION -----------------
44 L Z0 R0 FMAX M91
45 L X0 R0 FMAX M91
...
60 CYCL DEF 200 DRILLING~
  ...
  Q202=24.439 ;PLUNGING DEPTH~
  Q210=0 ;DWELL TIME AT TOP~
  Q203=0 ;SURFACE COORDINATE~
  Q204=30 ;2ND SET-UP CLEARANCE~
  Q211=0 ;DWELL TIME AT BOTTOM
61 L X-83 Y0 R0 F MAX M99
62 L X-3 Y0 R0 F MAX M99
63 L X77 Y0 R0 F MAX M99
64 L X157 Y0 R0 F MAX M99
65 M9
66 M5

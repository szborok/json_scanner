...
12 ;
13 ; --- TOOLLIST BEGIN ---------------
14 ; T1441696452 | KOM-U11-TF39_H63ABS50 / DM=39 CR=0 TL=227  
15 ; ---- TOOLLIST END ----------------
16 ;
17 ; --- BLOCK FORM -------------------
...
31 ; ----------------------------------
32 * - TOOL: T1441696452 | KOM-U11-TF39_H63ABS50 / DM=39 CR=0 TL=227
33 TOOL CALL "TF39000001670102" Z S900 DL+0 DR+0
...
60 CYCL DEF 200 DRILLING~
   ...
   Q202=32.851 ;PLUNGING DEPTH~
   Q210=0 ;DWELL TIME AT TOP~
   Q203=2 ;SURFACE COORDINATE~
   Q204=28 ;2ND SET-UP CLEARANCE~
   Q211=0 ;DWELL TIME AT BOTTOM
61 L X212 Y140 R0 F MAX M99
62 L X212 Y-162 R0 F MAX M99
63 L X-212 Y-162 R0 F MAX M99
64 L X-212 Y162 R0 F MAX M99
65 M9
66 M5

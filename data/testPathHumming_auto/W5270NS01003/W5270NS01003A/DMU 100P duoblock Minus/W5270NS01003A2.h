...
12 ;
13 ; --- TOOLLIST BEGIN ---------------
14 ; T1000367499 | KOM-U11-TF21_H63ABS50 / DM=21 CR=0 TL=158  
15 ; ---- TOOLLIST END ----------------
16 ;
17 ; --- BLOCK FORM -------------------
...
31 ; ----------------------------------
32 * - TOOL: T1000367499 | KOM-U11-TF21_H63ABS50 / DM=21 CR=0 TL=158
33 TOOL CALL "TF21000000980102" Z S1601 DL+0 DR+0
...
53 L X93.8371 Y100.5335 R0 F MAX M3 
54 L Z30 R0 F MAX
55 ; --- coolant.txt ----
56 M7
...
60 CYCL DEF 200 DRILLING~
   ...
   Q202=66.458 ;PLUNGING DEPTH~
   Q210=0 ;DWELL TIME AT TOP~
   Q203=2 ;SURFACE COORDINATE~
   Q204=28 ;2ND SET-UP CLEARANCE~
   Q211=0 ;DWELL TIME AT BOTTOM
61 L X93.8371 Y100.5335 R0 F MAX M99
62 L X72.724 Y145.8106 R0 F MAX M99
63 L X-101.1629 Y100.5335 R0 F MAX M99
64 L X-122.276 Y145.8106 R0 F MAX M99
65 M9
66 M5

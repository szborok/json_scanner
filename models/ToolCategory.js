class ToolCategory {
    static categories = {
        gundrill: {
            matchType: 'partial',
            tools: ['GUH-1865', 'GUH-3032', 'GUH-3033', 'GUH-3035', 'GUH-5639', 'GUH-5640', 'GUH-5641', 'GUH-5688', 'GUH-5691', 'GUH-49298', 'TUN-AF', 'TOO-AF'],
        },
        endmill_finish: {
            matchType: 'partial',
    ...
    static requiresM110(toolName) {
        return this.getToolCategories(toolName).some(cat => this.requiresM110Categories.includes(cat));
    }

    static getToolCategories(toolName) {
        const matched = [];

        for (const [category, { matchType, tools }] of Object.entries(this.categories)) {

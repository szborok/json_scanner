...
12 ;
13 ; --- TOOLLIST BEGIN ---------------
14 ; T435038524 | TGT-TOP4-TF19_H63W25L90 / DM=19 CR=0 TL=187  
15 ; ---- TOOLLIST END ----------------
16 ;
17 ; --- BLOCK FORM -------------------
...
31 ; ----------------------------------
32 * - TOOL: T435038524 | TGT-TOP4-TF19_H63W25L90 / DM=19 CR=0 TL=187
33 TOOL CALL "TF19000000970350" Z S1675 DL+0 DR+0
...
53 L X112.3107 Y-91.9813 R0 F MAX M3 
54 L Z30 R0 F MAX
55 ; --- coolant.txt ----
56 M7
...
60 CYCL DEF 200 DRILLING~
   ...
   Q202=76.415 ;PLUNGING DEPTH~
   Q210=0 ;DWELL TIME AT TOP~
   Q203=2 ;SURFACE COORDINATE~
   Q204=28 ;2ND SET-UP CLEARANCE~
   Q211=0 ;DWELL TIME AT BOTTOM
61 L X112.3107 Y-91.9813 R0 F MAX M99
62 L X100.3475 Y-124.8498 R0 F MAX M99
63 L X-69.6893 Y-91.9813 R0 F MAX M99
64 L X-81.6525 Y-124.8498 R0 F MAX M99
65 M9
66 M5
